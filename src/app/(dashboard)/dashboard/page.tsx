...
const ENSAIOS: Ensaio[] = [
  ...
  { id: 'aderencia',     label: 'Aderência',                 href: '/ensaios/aderencia' },
];
          ...
          {ENSAIOS.map((ensaio) => (
            <a
              ...
              style={{
                ...
                border: `1px solid ${hoveredCard === ensaio.id ? '#C8A020' : 'rgba(255,255,255,0.2)'}`,
